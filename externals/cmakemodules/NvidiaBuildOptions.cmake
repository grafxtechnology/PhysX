...
OPTION(NV_APPEND_CONFIG_NAME "Append config (DEBUG, ASAN, RELWITHDEBINFO or '' for release) to outputted binaries." OFF)
...
IF(NV_USE_GAMEWORKS_OUTPUT_DIRS)
	...
	SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PX_OUTPUT_LIB_DIR}/${PX_ROOT_LIB_DIR}/relwithdebinfo" )
	SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY_ASAN "${PX_OUTPUT_LIB_DIR}/${PX_ROOT_LIB_DIR}/asan" )
	...
	SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO "${PX_OUTPUT_LIB_DIR}/${PX_ROOT_LIB_DIR}/relwithdebinfo" )
	SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY_ASAN "${PX_OUTPUT_LIB_DIR}/${PX_ROOT_LIB_DIR}/asan" )
	...
	SET(PX_EXE_OUTPUT_DIRECTORY_RELWITHDEBINFO  	"${PX_OUTPUT_BIN_DIR}/${PX_ROOT_EXE_DIR}/relwithdebinfo" CACHE INTERNAL "Directory to put relwithdebinfo exes in")
	SET(PX_EXE_OUTPUT_DIRECTORY_ASAN 	"${PX_OUTPUT_BIN_DIR}/${PX_ROOT_EXE_DIR}/asan" CACHE INTERNAL "Directory to put asan exes in")
	...
	SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO  ${CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO}		)
	SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY_ASAN 	${CMAKE_ARCHIVE_OUTPUT_DIRECTORY_ASAN}  		)
...
IF(NV_APPEND_CONFIG_NAME)
	...
	SET(CMAKE_RELWITHDEBINFO_POSTFIX "RELWITHDEBINFO_${LIBPATH_SUFFIX}")
	SET(CMAKE_ASAN_POSTFIX "ASAN_${LIBPATH_SUFFIX}")
...
ELSE()
	IF (DEFINED PX_OUTPUT_ARCH)  # platforms with fixed arch like ps4 dont need to have arch defined, then dont add bitness
		...
		SET(CMAKE_RELWITHDEBINFO_POSTFIX "_${LIBPATH_SUFFIX}")
		SET(CMAKE_ASAN_POSTFIX "_${LIBPATH_SUFFIX}")
		SET(CMAKE_RELEASE_POSTFIX "_${LIBPATH_SUFFIX}")
	ENDIF()
ENDIF()
